...
public class Events
{
    ...
    public Events(string _name, double _price, string _imageUrl, int _amount, bool _discount)
    {
        name = _name;
        price = _price;
        imageUrl = _imageUrl;
    ...
    {
        DBservices dbs = new DBservices();
        dbs = dbs.ReadFromDataBase("ProductsDBConnectionString", "ProductsInShop");
